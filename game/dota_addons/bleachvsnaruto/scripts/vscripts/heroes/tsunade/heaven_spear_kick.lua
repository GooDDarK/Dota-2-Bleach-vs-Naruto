...
function LariatPeriodic(gameEntity, keys)
	...
	local targetEntities = FindUnitsInRadius(caster:GetOpposingTeamNumber(), caster:GetAbsOrigin(), nil,
		3*caster:GetPaddedCollisionRadius(), DOTA_UNIT_TARGET_TEAM_FRIENDLY, DOTA_UNIT_TARGET_BASIC + DOTA_UNIT_TARGET_HERO, DOTA_UNIT_TARGET_FLAG_NONE, FIND_CLOSEST, false)
