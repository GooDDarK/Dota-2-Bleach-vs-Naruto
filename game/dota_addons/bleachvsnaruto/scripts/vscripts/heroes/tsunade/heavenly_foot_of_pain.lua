function launch( keys )
	...
	local wave_speed = ability:GetLevelSpecialValueFor("speed", (ability:GetLevel() - 1))
	local wave_width = ability:GetLevelSpecialValueFor("radius_start", (ability:GetLevel() - 1))
	local wave_width_end = ability:GetLevelSpecialValueFor("radius_end", (ability:GetLevel() - 1))
	local wave_range = ability:GetLevelSpecialValueFor("range", (ability:GetLevel() - 1))
