...
function summon_karasu( keys )
	...
	if (ability:GetLevel() == 1) then
		...
		karasu_unit:FindAbilityByName("lone_druid_spirit_bear_return"):SetLevel(1)
		karasu_unit:FindAbilityByName("karasu_daggers"):SetLevel(0)
		karasu_unit:FindAbilityByName("venomancer_poison_nova"):SetLevel(0)
	...
	elseif (ability:GetLevel() == 3) then
		...
		karasu_unit:FindAbilityByName("lone_druid_spirit_bear_return"):SetLevel(1)
		karasu_unit:FindAbilityByName("karasu_daggers"):SetLevel(1)
		karasu_unit:FindAbilityByName("venomancer_poison_nova"):SetLevel(1)
		karasu_unit:FindAbilityByName("karasu_critical_strike"):SetLevel(0)
