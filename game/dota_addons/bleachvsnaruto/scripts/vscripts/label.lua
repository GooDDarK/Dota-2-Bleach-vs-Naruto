function GameMode:setPlayerHealthLabel( player )
	  print('setPlayerHealthLabel')
    if PlayerResource:IsValidPlayerID(player:GetPlayerID()) then
		  print('setPlayerHealthLabel2')
        if not PlayerResource:IsBroadcaster(player:GetPlayerID()) then
				  print('setPlayerHealthLabel3')
          --gooddark
          if PlayerResource:GetSteamAccountID(player:GetPlayerID()) == 111179147 then
		  				  print('setPlayerHealthLabel4')
            if player:GetAssignedHero() ~= nil then
			print('setPlayerHealthLabel5')
