...
Предметы и некоторые скиллы героев (но не все) стандартные, а не кастомные, просто немного изменены. По этому глобальных изменений и/или изменений характеристик этих предметов/скиллов от Valve так же нету в кастомке со времен ~7.22.
